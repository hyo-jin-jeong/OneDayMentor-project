...
<body >
	...
	<div style="height: 300px; margin-bottom: 50px;">
		<img src="img/board.jpg" style="width: 100%; height: 100%;">
	</div>
		...
		<div class="main" style="margin-left : 70px;">
			...
			<div class="row">
				...
				<div class="row card"
					...
					<div class="col-lg-4 banner" style="height: 450px;margin-left: 30px;">
						...
						%>
							...
							%><h4 style="margin-left : 25px; width:50px;">멘티</h4>
							<%
								} else { // 멘토일 때
							%><h4 style="margin-left : 25px;width:50px">멘토</h4>
							<%
								}
							%>
						...
						<div style="width: 100px;">
							...
							<h4 style="overflow: hidden;">
								<a href="view.jsp?bbsID=<%=list_3.get(i).getBbsID()%>"> <%=list_3.get(i).getBbsTitle()%></a>
							</h4>
							<%
								} else { //비회원일때 글제목 못누름
							%>
							<h2><%=list_3.get(i).getBbsTitle()%></h2>

							<%
								}
							%>
							<p style="width: 120px;"><%=list_3.get(i).getBbsDate().substring(0, 11) + list_3.get(i).getBbsDate().substring(11, 13)
						+ "시" + list_3.get(i).getBbsDate().substring(14, 16) + "분"%></p>
							<p><%=category.getCategoryKorean(list_3.get(i).getCategoryID())%></p>
							...
							<%
								...
								<button type="button" id="chat" name="chat2"
									...
									style="height: 30px;margin-left: 8px; margin-right: 8px;">chat</button>
								<%
									} else if (chatDAO.getAvailable(applyDAO.getApplyID2(userID, list_3.get(i).getBbsID())) == 1
												&& !applyDAO.isMentee(id, userID)
												&& chatDAO.getEthReceipt(applyDAO.getApplyID2(userID, list_3.get(i).getBbsID())) == 0) {
							...
							<button type="button" id="getMoney"
								...
								class="btn btn-primary" style="height: 30px; margin-left: 8px;margin-right: 8px;"
