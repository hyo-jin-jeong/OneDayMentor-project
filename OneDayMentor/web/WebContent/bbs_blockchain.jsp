...
<body>
	...
	<div data-aos="zoom-out" data-aos-duration="1000" style="height:250px; background-image:url('img/board.jpg'); background-size:100% 250px; background-repeat:no-repeat;">
		<div
			style="font-size: 40px; color: white; text-shadow: 1px 1px 1px black; position: absolute; top: 150px; left: 510px; z-index: 1;">
			<b>블록체인 게시판</b>
		</div>
	</div>
	<%
	...
	<div id="menu">
		...
		<div id="menuDiv">
			<ul id="menuContent" class="nav">
				<li class="active"><a href="bbs_blockchain.jsp">블록체인</a></li>
				<br>
				<li><a href="bbs_economy.jsp">경제, 경영</a></li>
				<li><a href="bbs_law.jsp">법, 법률</a></li>
				<br>
				<li><a href="bbs_foreign.jsp">어학, 외국어</a></li>
		...
		<div class="main">
			...
			<!-- 페이지 넘기기 -->
				...
				<table class="table table-striped"
					...
					width: 80%; border-top: 1px solid #dddddd; padding: 20px; border-bottom: 1px solid #dddddd; table-layout: fixed;">
					...
					<thead style="background-color: #3d3d3d;">
						<tr style="height: 55px;">
							...
							<th
								style="font-size: 15px; vertical-align: middle; background-color: #1e3c74; color: white; text-align: center;">Title</th>
							<th
								style="font-size: 15px; vertical-align: middle; background-color: #1e3c74; color: white; text-align: center;">Writer</th>
							<th
								style="font-size: 15px; vertical-align: middle; background-color: #1e3c74; color: white; text-align: center;">Date</th>
						</tr>
					</thead>
					...
					<tbody>
						...
						%>
						<tr style="background-color: #1e3c74; height: 0.5px">
							<td></td>
							<td></td>
							<td></td>
							<td></td>
			...
			<%
									if (pageNumber != 0) {
								%>
								<a href="bbs_blockchain.jsp?pageNumber=<%=pageNumber - 1%>"
