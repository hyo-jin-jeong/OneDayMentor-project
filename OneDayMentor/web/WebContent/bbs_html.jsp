...
<body>
	...
	<div data-aos="zoom-out" data-aos-duration="1000" style="height:250px; background-image:url('img/board.jpg'); background-size:100% 250px; background-repeat:no-repeat;">
		<div
			style="font-size: 40px; color: white; text-shadow: 1px 1px 1px black; position: absolute; top: 110px; left: 410px; z-index: 1;">
			<b>HTML/CSS/Javascript 게시판</b>
		</div>
	...
	<div id="menu">
		...
		<div id="menuDiv">
			<ul id="menuContent" class="nav">
				...
				<li class="active"><a href="bbs_html.jsp">HTML/CSS/Javascript</a></li>
			...
			<!-- 페이지 넘기기 -->
				...
				<div style="text-align: center;">
					<%
						if (pageNumber != 0) {
					%>
					<a href="bbs_html.jsp?pageNumber=<%=pageNumber - 1%>"
