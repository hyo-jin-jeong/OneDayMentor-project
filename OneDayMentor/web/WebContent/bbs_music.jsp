...
<body>
	...
	<div data-aos="zoom-out" data-aos-duration="1000" style="height: 300px; margin-bottom: 50px;background-image:url('img/board.jpg'); background-size:100% 300px;">
		<div
			style="font-size: 40px; color: white; text-shadow: 1px 1px 1px black; position: absolute; top: 180px; left: 500px; z-index: 1;">
			<b>음악 게시판</b>
		</div>
	...
	<div id="menu">
		...
		<div id="menuDiv">
			<ul id="menuContent" class="nav">
				...
				<br>
				<li class="active"><a href="bbs_music.jsp">음악</a></li>
			...
			<div style="text-align: center;">
				...
				<div style="text-align: center;">
					<%
						if (pageNumber != 0) {
					%>
					<a href="bbs_music.jsp?pageNumber=<%=pageNumber - 1%>"
