...
<body>
	...
	<div data-aos="zoom-out" data-aos-duration="1000" style="height: 250px; background-image:url('img/board.jpg'); background-size:100% 250px;">
	<div style="font-size: 40px; color: white; text-shadow: 1px 1px 1px black; position: absolute; top: 110px; left: 510px; z-index: 1;">
		<b>미술, 애니메이션 게시판</b>
	</div>
	</div>
	<div class="btn1"></div>
	...
	<div id="menu">
		...
		<div id="menuDiv">
			<ul id="menuContent" class="nav">
				...
				<li class="active"><a href="bbs_art.jsp">미술, 애니메이션</a></li>
				<br>
			...
			<div class="row">
				...
				<div style="text-align: center;">
					<%
						if (pageNumber != 0) {
					%>
					<a href="bbs_art.jsp?pageNumber=<%=pageNumber - 1%>"
					...
					<a href="write.jsp?CID=<%=CID%>" class="btn btn-primary pull-right" style="margin-right:110px;">Write</a>
					<%
						} else {
					%>
					...
					<a
						...
						style="margin-right: 50px; color : black; font-size: 20px;"><b>write</b><img id="pencilimg" src="img/pencil.png" style="width:50px;height:50px;"></a>
					<%
						}
										%>
				</div>
